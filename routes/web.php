...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::post('products/masiveUpdatePercent', 'ProductController@massiveUpdatePercent');
    ...
    Route::post('products/selectionUpdate', 'ProductController@selectionUpdate');
    ...
    Route::get('/afipInvoice/{id}', 'SellController@afipInvoice');
