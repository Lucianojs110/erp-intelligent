    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stock_transfers.view', in_array('stock_transfers.view', $role_permissions),['class' => 'input-icheck']); !!}
                {{ __('lang_v1.stock_transfers.view') }}
              </label>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stock_transfers.create', in_array('stock_transfers.create', $role_permissions),['class' => 'input-icheck']); !!}
                {{ __('lang_v1.stock_transfers.create') }}
              </label>
            </div>
          </div>
