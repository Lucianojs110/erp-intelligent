            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="product_list_tab">
                        ...
                        <a class="btn btn-info" href="#" id="updateSelected">
                            <i class="fa fa-industry"></i> Actualizar productos seleccionados</a>
                        <a class="btn btn-warning" href="{{action('ProductController@massiveUpdate')}}">
                            <i class="fa fa-industry"></i> Actualizar precios masivamente</a>
                        <br><br>
                        @endcan
